...
- **Resilience pipeline (Polly v8)** — Use the standard resilience handler on `HttpClient`; do not hand-roll retry/circuit-breaker loops.
  See [docs/02-aspnetcore.md §7 Resilience](../docs/02-aspnetcore.md#7-resilience) and [docs/06-cloud-native.md §6 Resilience](../docs/06-cloud-native.md#6-resilience-see-ch02-7).
